        ...
        {list.map((item: any) => (
          ...
          >
            ...
            >
              ...
              {item.type === "base64" && (
                <Box sx={{ display: "grid", placeItems: "center", width: "100%"}}><input type="file" ref={inputRef} style={{ display: 'none' }} 
                disabled={type !== "update"} onChange={handleImageUpload} /><img onClick={handleImageClick} src={`${dataState![item.key as keyof typeof dataState]}`} alt={data["Name"] + "_cover"} style={{ width: 100 }} /></Box>
              )}
